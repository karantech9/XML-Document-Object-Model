...
* --------------------
* ver 1.6 : 25 Mar 15
* added string() function fo CommentTag
* ver 1.5 : 24 Feb 15
...
namespace XmlProcessing
{
  ...
  public:
	...
	virtual std::vector<std::pair<std::string, std::string>> returnAttrib();
  ...
  inline std::vector<std::shared_ptr < AbstractXmlElement >> AbstractXmlElement::children() 
  { 
	  std::vector<std::shared_ptr < AbstractXmlElement >> a;
	  return a;
  }
  inline std::vector<std::pair<std::string, std::string>> AbstractXmlElement::returnAttrib()
  {
