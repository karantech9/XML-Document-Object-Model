...
//----< return child vector from doc element >---------------
...
//----< return attributes vector from taggedElement element >---------------

std::vector<std::pair<std::string, std::string>> TaggedElement::returnAttrib()
{
	return attribs_;
}

//----< return child vector from taggedElement element >---------------
...
//----< return attributes vector for ProcInstrElement element >-------------------------------

std::vector<std::pair<std::string, std::string>> ProcInstrElement::returnAttrib()
{
	return attribs_;
}

//----< generate xml string for ProcInstrElement element >-------------------------------
...
//----< return attributes vector for XmlDeclarElement element >-------------------------------

std::vector<std::pair<std::string, std::string>> XmlDeclarElement::returnAttrib()
{
	return attribs_;
}
